...
export const ModalExportar: React.FC<ModalExportarProps> = ({
    ...
    const handleExport = () => {
        if (tipo === "completados" && mostrarFechas) {
            ...
            onExport({ tipo, fechaInicio, fechaFin });
        } else {
            onExport({ tipo });
        }
        onClose();
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                ...
                <div className="mb-4">
                    ...
                    <select
                        value={tipo}
                        onChange={(e) =>
                            setTipo(e.target.value as "activos" | "completados")
                        }
                        className="w-full border rounded px-2 py-1"
                    >
                        <option value="activos">{recurso} activos</option>
                        <option value="completados">{recurso} completos o archivados</option>
                    </select>
                </div>
                ...
                <>
                    <p className="text-sm text-gray-600 mb-2">
                        Selecciona el rango de fechas de <strong>devolución real</strong> a exportar.
                    </p>
                    <div className="mb-4">
